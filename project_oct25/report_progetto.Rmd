...
<style>
/* Stile per rendere le tabelle di output più leggibili */
...
## Task 11.3: Top 10 Most Frequently Hit Genes
This sub-task calculates how many distinct samples contribute to the HIGH-impact summary for each gene and returns the top 10 genes with the highest number of hit samples.
```{r}
